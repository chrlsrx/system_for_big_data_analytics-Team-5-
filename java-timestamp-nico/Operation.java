...
public class Operation {
	...
	public Operation(final int id, Target target, String operation_type) {
		// READ operation
		this.id = id;
		this.target = target;
	...
	public Operation(final int id, Target target, String operation_type, Function function) {
		// WRITE operation
		this.id = id;
		this.target = target;
		this.operation_type = operation_type;
	...
	public boolean apply() {
		if (this.operation_type == READ) {
			...
			this.local_target.update(self.local_target.apply(this.function));
			this.has_applied = true;
		}
